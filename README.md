...
For our code reproduction, we focused on three modes: High Lesion, Low Background and Whole. We trained ResNet50 on the ISIC Dataset and cross evaluated our models on the HAM10000 dataset. For an ablation study, we trained a ResNet34 model and performed cross evaluations on the same datsets. 
